...
setenv G4LIB "`cd $geant4make_root/../../../lib/Geant4-11.3.0 > /dev/null ; pwd`"
...
setenv G4LEDATA "`cd $geant4make_root/../data/G4EMLOW8.6.1 > /dev/null ; pwd`"
setenv G4LEVELGAMMADATA "`cd $geant4make_root/../data/PhotonEvaporation6.1 > /dev/null ; pwd`"
setenv G4RADIOACTIVEDATA "`cd $geant4make_root/../data/RadioactiveDecay6.1.2 > /dev/null ; pwd`"
setenv G4PARTICLEXSDATA "`cd $geant4make_root/../data/G4PARTICLEXS4.1 > /dev/null ; pwd`"
...
setenv G4ENSDFSTATEDATA "`cd $geant4make_root/../data/G4ENSDFSTATE3.0 > /dev/null ; pwd`"
setenv G4CHANNELINGDATA "`cd $geant4make_root/../data/G4CHANNELING1.0 > /dev/null ; pwd`"
